...
import 'package:manhatan_project/presentation/components/common/bottom_navbar.dart';
import 'package:manhatan_project/presentation/components/common/skeleton_home_page.dart';
import 'package:manhatan_project/presentation/pages/isi_artikel.dart';
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const IsiArtikel(),
                          ),
                        );
                      },
                      child: Padding(
